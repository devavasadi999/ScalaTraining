...
object EmailUtils {
  ...
  val senderEmail = "tejakumar023@gmail.com" // Sender's email
  val senderName = "Meeting Roon Management" // Sender's display name
  val senderPassword = scala.Settings.password // Sender's email password
