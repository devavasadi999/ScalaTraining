...
/** Represents aggregated sensor metrics
  *
  * @param sensorId
  ...
  *   Maximum humidity
  * @param dataCount
  *   Count of detected anomalies (e.g., unusual spikes, deviations)
  */
@SerialVersionUID(0L)
final case class AggregatedSensorMetrics(
    ...
    dataCount: _root_.scala.Int = 0,
    unknownFields: _root_.scalapb.UnknownFieldSet = _root_.scalapb.UnknownFieldSet.empty
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[AggregatedSensorMetrics] {
    @transient
    ...
    def withSensorId(__v: _root_.scala.Predef.String): AggregatedSensorMetrics = copy(sensorId = __v)
    def withAvgTemperature(__v: _root_.scala.Float): AggregatedSensorMetrics = copy(avgTemperature = __v)
    def withAvgHumidity(__v: _root_.scala.Float): AggregatedSensorMetrics = copy(avgHumidity = __v)
    def withMinTemperature(__v: _root_.scala.Float): AggregatedSensorMetrics = copy(minTemperature = __v)
    def withMaxTemperature(__v: _root_.scala.Float): AggregatedSensorMetrics = copy(maxTemperature = __v)
    def withMinHumidity(__v: _root_.scala.Float): AggregatedSensorMetrics = copy(minHumidity = __v)
    def withMaxHumidity(__v: _root_.scala.Float): AggregatedSensorMetrics = copy(maxHumidity = __v)
    def withDataCount(__v: _root_.scala.Int): AggregatedSensorMetrics = copy(dataCount = __v)
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 8 => _root_.scalapb.descriptors.PInt(dataCount)
      }
    }
    def toProtoString: _root_.scala.Predef.String = _root_.scalapb.TextFormat.printToUnicodeString(this)
    def companion: case_study_1.AggregatedSensorMetrics.AggregatedSensorMetrics.type = case_study_1.AggregatedSensorMetrics.AggregatedSensorMetrics
    // @@protoc_insertion_point(GeneratedMessage[case_study_1.AggregatedSensorMetrics])
}

object AggregatedSensorMetrics extends scalapb.GeneratedMessageCompanion[case_study_1.AggregatedSensorMetrics.AggregatedSensorMetrics] {
  implicit def messageCompanion: scalapb.GeneratedMessageCompanion[case_study_1.AggregatedSensorMetrics.AggregatedSensorMetrics] = this
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): case_study_1.AggregatedSensorMetrics.AggregatedSensorMetrics = {
    ...
    var __dataCount: _root_.scala.Int = 0
    ...
    while (!_done__) {
      ...
      _tag__ match {
        ...
        case 64 =>
          __dataCount = _input__.readInt32()
        case tag =>
    ...
    case_study_1.AggregatedSensorMetrics.AggregatedSensorMetrics(
        ...
        dataCount = __dataCount,
        unknownFields = if (_unknownFields__ == null) _root_.scalapb.UnknownFieldSet.empty else _unknownFields__.result()
    )
  }
  implicit def messageReads: _root_.scalapb.descriptors.Reads[case_study_1.AggregatedSensorMetrics.AggregatedSensorMetrics] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      case_study_1.AggregatedSensorMetrics.AggregatedSensorMetrics(
        ...
        dataCount = __fieldsMap.get(scalaDescriptor.findFieldByNumber(8).get).map(_.as[_root_.scala.Int]).getOrElse(0)
      )
    case _ => throw new RuntimeException("Expected PMessage")
  }
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = AggregatedSensorMetricsProto.javaDescriptor.getMessageTypes().get(0)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = AggregatedSensorMetricsProto.scalaDescriptor.messages(0)
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = throw new MatchError(__number)
  lazy val nestedMessagesCompanions: Seq[_root_.scalapb.GeneratedMessageCompanion[_ <: _root_.scalapb.GeneratedMessage]] = Seq.empty
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = throw new MatchError(__fieldNumber)
  lazy val defaultInstance = case_study_1.AggregatedSensorMetrics.AggregatedSensorMetrics(
    sensorId = "",
    avgTemperature = 0.0f,
    avgHumidity = 0.0f,
    minTemperature = 0.0f,
  ...
  implicit class AggregatedSensorMetricsLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, case_study_1.AggregatedSensorMetrics.AggregatedSensorMetrics]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, case_study_1.AggregatedSensorMetrics.AggregatedSensorMetrics](_l) {
    ...
    def dataCount: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Int] = field(_.dataCount)((c_, f_) => c_.copy(dataCount = f_))
  }
  ...
  final val DATACOUNT_FIELD_NUMBER = 8
  def of(
    sensorId: _root_.scala.Predef.String,
    ...
    dataCount: _root_.scala.Int
  ): _root_.case_study_1.AggregatedSensorMetrics.AggregatedSensorMetrics = _root_.case_study_1.AggregatedSensorMetrics.AggregatedSensorMetrics(
    sensorId,
    avgTemperature,
    avgHumidity,
    minTemperature,
  ...
  // @@protoc_insertion_point(GeneratedMessageCompanion[case_study_1.AggregatedSensorMetrics])
}
